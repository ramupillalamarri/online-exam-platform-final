...
function FloatingOrb({ className = "", delay = 0, duration = 20, size = "md" }: FloatingOrbProps) {
  const sizes = {
    sm: "w-24 h-24",
    md: "w-40 h-40",
    lg: "w-64 h-64",
...
interface AnimatedBackgroundProps {
  variant?: "default" | "subtle" | "vibrant" | "hero"
  children?: React.ReactNode
}

export function AnimatedBackground({ variant = "default", children }: AnimatedBackgroundProps) {
  const opacityClass = {
    default: "opacity-40",
    subtle: "opacity-25",
    vibrant: "opacity-60",
